   ...
   // 		// echo "\n";
    	...
    	//			// echo "\n";
                  // // echo yaml_emit($month)."\n";
                    mkdir("/home/tom/github/website/sources/gobal/_data/incomming/".str_pad($ykey, 2, '0', STR_PAD_LEFT)."/", 0755, true);
            		chdir("/home/tom/github/website/sources/gobal/_data/incomming/".str_pad($ykey, 2, '0', STR_PAD_LEFT)."/");
            		
            		foreach ($month as $dkey => $day) {
            		
            			//yaml_emit_file ("dba-".str_pad($mkey, 2, '0', STR_PAD_LEFT)."-".str_pad($dkey, 2, '0', STR_PAD_LEFT).".yml" , $day);  
            		
            	
            		
            		if (file_exists("dba-".str_pad($mkey, 2, '0', STR_PAD_LEFT)."-".str_pad($dkey, 2, '0', STR_PAD_LEFT).".yml")) {
            			$tmp_db = yaml_parse_file("dba-".str_pad($mkey, 2, '0', STR_PAD_LEFT)."-".str_pad($dkey, 2, '0', STR_PAD_LEFT).".yml");
