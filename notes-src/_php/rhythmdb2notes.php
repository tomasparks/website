   ...
   // 		// echo "\n";
    	...
    	//			// echo "\n";
                  // // echo yaml_emit($month)."\n";
                    mkdir("/home/tom/github/website/sources/notes-src/_php/".str_pad($ykey, 2, '0', STR_PAD_LEFT)."/", 0755, true);
            		chdir("/home/tom/github/website/sources/notes-src/_php/".str_pad($ykey, 2, '0', STR_PAD_LEFT)."/");
